...
\usepackage{fancyhdr} % Head note and footnote
    ...
    \fancyhf{}
    \fancyhead[L]{
        \includegraphics[scale = 0.4]{Images/NovaFct.png}
    } % Left of Head note
...
\begin{center}
    ...
    \end{figure}
    \mbox{}\\[2.0cm]
    \textsc{\Huge MEEC}\\[2.5cm]
    \textsc{\LARGE Electronics for Micro-Systems}\\[2.0cm]
    \vspace{1cm}
    \HRule\\[0.4cm]
    {\large \bf {Individual Assignment Problems Solving Analysis} [\texttt{EN}]}\\[0.2cm]
    \HRule\\[1.5cm]
\end{center}
\vspace{2.5cm}
\begin{flushleft}
...
\begin{center}
    \begin{minipage}{0.5\textwidth}
        \begin{flushleft}
            Francisco Sá da Costa (70386)\\
        \end{flushleft}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \begin{flushright}
            \href{mailto:fsc.costa@campus.fct.unl.pt}{\texttt{md.agostinho@campus.fct.unl.pt}}\\
        \end{flushright}
    \end{minipage}
\end{center}
...
\subfile{Sections/P3.tex}
\subfile{Sections/P4.tex}
\subfile{Sections/P5.tex}
\subfile{Sections/P6.tex}
