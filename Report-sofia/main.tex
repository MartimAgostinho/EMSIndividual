...
\usepackage{fancyhdr} % Head note and footnote
    \pagestyle{fancy}
    \fancyhf{}
    \setlength{\headheight}{25.35614pt}
    \addtolength{\topmargin}{-13.35614pt}
    \fancyhead[L]{
...
\begin{center}
    ...
    \HRule\\[0.4cm]
    {\large \bf {Individual Assignment}}\\[0.2cm] % [\texttt{EN}]
    \HRule\\[1.5cm]
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Include the sections of the document
\subfile{Sections/problem1.tex}
\subfile{Sections/problem2.tex}
\subfile{Sections/problem3.tex}
\subfile{Sections/problem4.tex}
\subfile{Sections/problem5.tex}
\subfile{Sections/problem6.tex}
